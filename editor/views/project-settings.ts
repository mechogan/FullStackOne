...
export function ProjectSettings(opts: ProjectSettingsOpts) {
    ...
    form.onsubmit = async e => {
        ...
        if (updatedTitle === opts.project.title && updatedIdentifier === opts.project.id)
        ...
        if (updatedIdentifier !== project.id) {
            ...
            await rpc().fs.rename(opts.project.location, updatedIdentifier, { absolutePath: true });
