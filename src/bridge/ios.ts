...
import { bytesToNumber, deserializeArgs, numberTo4Bytes } from "../serialization";

const requests = new Map<number, (data: Uint8Array) => void>();

export const BridgeIOS: typeof ipc.bridge = async (payload: Uint8Array, transformer?: (responseArgs: any[]) => any) => {
    ...
    const base64 = fromByteArray(new Uint8Array([
        ...numberTo4Bytes(requestId),
        ...payload
    ]))
